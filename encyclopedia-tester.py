...
def new_player(room_name, player_name,encyclopedia_activated):
    ...
    while True:
        ...
        try:
            ...
            if(encyclopedia_activated.value == 0):
                ...
                player_choice_button = driver_player_name.find_element("xpath",'//button[contains(text(),"Check Source")]')
                ...
                encyclopedia_box = driver_player_name.find_element("xpath",'//div[contains(@class,"encyclopedia-box")]')
                sleep(2)
                encyclopedia_box.find_element("xpath", '//span[contains(text(), "{}")]'.format(player_card_text.text))
                print(str(player_name) + " Successfully Used Encyclopedia Search")
                sleep(2)
                encyclopedia_activated.value = 1
            ...
            elif (encyclopedia_activated.value == 1):
                break
...
if __name__ == '__main__' :
    ...
    print("Testing the special power: Check Source/Encyclopedia Search")
        ...
        while True:
            ...
            try:
                ...
                if(encyclopedia_activated.value == 0):
                    ...
                    player_choice_button = driver_john.find_element("xpath",'//button[contains(text(),"Check Source")]')
                    ...
                    encyclopedia_box = driver_john.find_element("xpath",'//div[contains(@class,"encyclopedia-box")]')
                    sleep(2)
                    encyclopedia_box.find_element("xpath", '//span[contains(text(), "{}")]'.format(player_card_text.text))
                    print("john Successfully Used Encyclopedia Search")
                    sleep(2)
                    encyclopedia_activated.value = 1
                    sleep(15)
